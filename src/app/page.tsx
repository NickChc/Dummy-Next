  ...
  return (
    <div className="w-[80%] text-center flex flex-col items-center">
      ...
      <HomeCard
        ...
        description="Well, I made this app simply to train myself in next.js practice. I used layouts, error pages, dynamic routes, params and searchParams, SSR and client components. I know it is just a begining of next.js I have just began. 😊"
      />
    </div>
  );
}
